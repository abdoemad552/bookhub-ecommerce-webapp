...
<div class="min-h-screen bg-background flex flex-col overflow-hidden">
  ...
  <main class="flex-1 flex items-center justify-center px-4 py-16 relative">
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute top-20 left-10 animate-pulse">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             ...
             class="lucide lucide-book-open w-8 h-8 text-primary/10" aria-hidden="true">
      ...
      <div class="absolute top-40 right-20 animate-pulse" style="animation-delay:0.5s">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-book-open w-12 h-12 text-primary/10" aria-hidden="true">
          <path d="M12 7v14"></path>
          <path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path>
        </svg>
      </div>
      <div class="absolute bottom-32 left-1/4 animate-pulse" style="animation-delay:0.25s">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-book-open w-6 h-6 text-primary/10" aria-hidden="true">
          <path d="M12 7v14"></path>
          <path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path>
        </svg>
      </div>
      <div class="absolute bottom-20 right-1/3 animate-pulse" style="animation-delay:0.75s">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
             class="lucide lucide-book-open w-10 h-10 text-primary/10" aria-hidden="true">
          <path d="M12 7v14"></path>
          <path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"></path>
        </svg>
      </div>
    ...
    <div class="max-w-xl w-full text-center relative z-10">
        ...
        <div class="relative inline-flex items-center justify-center">
          <svg viewBox="0 0 200 180" class="w-64 h-56" xmlns="http://www.w3.org/2000/svg">
            ...
            <g>
              ...
              <path d="M130 40 Q150 50 145 80 L130 80 Z" class="fill-background stroke-primary/30"
                    stroke-width="1"></path>
            ...
            <text x="100" y="30" text-anchor="middle" class="fill-primary/50 text-3xl font-bold animate-pulse"
      ...
      <p class="text-base text-muted-foreground mb-8 text-balance max-w-md mx-auto">This page seems to have wandered off
        the shelves. Let us help you find your way back to our collection.</p>
      <div class="flex flex-col sm:flex-row gap-3 justify-center mb-10">
        ...
        <a href="${pageContext.request.contextPath}/explore">
          <button data-slot="button"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                 class="lucide lucide-search w-4 h-4 mr-2" aria-hidden="true">
