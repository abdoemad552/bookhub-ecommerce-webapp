        ...
        <div class="space-y-5">
            <div class="flex gap-3 items-center w-full">
                <div class="flex-1 relative">
                    ...
                    <input id="search-input" type="text" placeholder="Search books..." class="w-full pl-10 pr-4 py-2 rounded-full shadow-sm border border-border bg-white text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all duration-150" value="${requestScope.query}"/>
                </div>
                <button id="open-books-filter-modal-btn" type="button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold bg-card shadow-sm hover:bg-accent hover:text-accent-foreground active:text-accent-foreground active:bg-accent/80 active:scale-95 border h-10 px-3 rounded-2xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-all duration-150">
                ...
                <a href="${pageContext.request.contextPath}/cart">
                    <button data-slot="button" class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowedshrink-0 focus:outline-none active:scale-95 focus:ring-2 focus:ring-offset-2 focus:ring-primary text-primary-foreground active:bg-primary/80 h-9 px-4 py-2 bg-primary hover:bg-primary/90">
            ...
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6 px-3">
                <div class="flex items-center gap-2 select-none">
                    <h2 id="grid-selected-category" class="text-2xl font-bold text-foreground">Explore</h2>
