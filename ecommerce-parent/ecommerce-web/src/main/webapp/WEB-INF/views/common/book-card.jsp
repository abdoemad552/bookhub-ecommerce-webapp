    ...
    <div
        ...
        <div class="p-3 sm:p-4 flex flex-col flex-1 min-w-0 select-none">
            ...
            <div class="flex items-start justify-between gap-2 mb-1">
                <h3 class="font-semibold text-foreground text-sm sm:text-base line-clamp-2 leading-snug truncate">
                        ${book.title}
                </h3>
                <c:if test="${book.stockQuantity le 0}">
                    <span class="shrink-0 text-xs bg-red-100 text-red-800 rounded-md px-2 py-0.5 font-medium">
                        Out of stock
                    </span>
                </c:if>
            </div>
