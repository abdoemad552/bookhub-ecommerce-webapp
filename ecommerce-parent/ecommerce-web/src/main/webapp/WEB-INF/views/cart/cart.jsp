    ...
    <c:choose>
      ...
      <c:otherwise>
        <section class="flex flex-col gap-6">
          ...
          <!-- Bottom row: Summary + Perks -->
          <div class="cart-bottom-row">

            <!-- LEFT: Trust / Perks -->
            <aside class="cart-perks-card scroll-reveal" style="animation-delay: 200ms">
              <h3 class="cart-perks-title">Why shop with us</h3>
              ...
              <div class="cart-trust-badges">
                ...
                <div class="cart-trust-item">
                  ...
                  <div>
                    <p class="cart-trust-title">Secure Checkout</p>
                    <p class="cart-trust-desc">Your cart is synced safely with your account.</p>
                  </div>
                </div>
                ...
                <div class="cart-trust-item">
                  ...
                  <div>
                    <p class="cart-trust-title">Easy Returns</p>
                    <p class="cart-trust-desc">30-day hassle-free return policy.</p>
                  </div>
                </div>
                ...
                <div class="cart-trust-item">
                  ...
                  <div>
                    <p class="cart-trust-title">Curated Titles</p>
                    <p class="cart-trust-desc">Every book is handpicked by our editorial team.</p>
                  </div>
                </div>
              </div>
            </aside>
